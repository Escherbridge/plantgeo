...
#: module-level tuple left for this walk to see as an offender. Kept as a real (initially empty) set,
#: not a comment, so the next offender this walk finds has somewhere to go without inventing the
#: shape.
