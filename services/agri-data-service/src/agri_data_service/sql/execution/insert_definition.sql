...
--         where the job contract permits), max_attempts/lease_seconds/time_budget_seconds (integer),
--         retry_policy/parameters (JSON text)
--
...
--     turn canonical JSON strings into the table's jsonb columns. true is the initial state of a newly
--     activated definition, not an update to an existing definition.
--
...
VALUES (
    :name, :version, :handler, :queue_name, :schedule, :schedule_timezone, true,
