...
| Herbaria specimens | [PNW Herbaria admission](tracks/pnw_herbaria_source_admission_20260911/plan.md) | WTU EML/release identity now measured for two releases (GBIF UUID `8310f570-...`); resolve WTU/UBC coordinate policy, field maps, and quarantine controls before any specimen archive pilot. Occurrence Parquet lane, species-profile Parquet lookup, and map-experience implementation started 2026-09-12 in worktree `claude/herbaria-botanical-lanes` (pending review, no archive acquisition). |
