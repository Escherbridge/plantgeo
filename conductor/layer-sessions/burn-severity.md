...
```bash
uv run agri-cli parquet-drain --dry-run --selection missing --layer burn-severity   # confirm the count first
uv run agri-cli parquet-drain --selection missing --layer burn-severity --progress
```
