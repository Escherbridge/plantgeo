...
```bash
uv run agri-cli parquet-drain --dry-run --selection missing --layer vegetation   # confirm the count first
uv run agri-cli parquet-drain --selection missing --layer vegetation --progress
```
