...
```bash
uv run agri-service data parquet-drain --dry-run --selection missing --layer {lane}   # confirm the count first
uv run agri-service data parquet-drain --selection missing --layer {lane} --progress
```
