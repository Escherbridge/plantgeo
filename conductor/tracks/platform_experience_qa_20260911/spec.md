...
| PNW/GIS contact research task, [land context plane](../pnw_land_context_reference_plane_20260911/plan.md) and [contact experience](../pnw_land_contact_experience_20260911/plan.md) | Bind the completed planning evidence. These tracks remain planned and their UI/agent cases stay blocked until exact sources and rights are admitted; research is not authorization to contact people, ingest or publish. |
| [PNW Herbaria source admission](../pnw_herbaria_source_admission_20260911/plan.md) | Keep specimen-source rights, coordinate withholding and archive safety separate from land/contact planning; inspect only admitted releases or explicitly blocked claims. |
