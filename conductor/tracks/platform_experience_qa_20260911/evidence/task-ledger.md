...
continuation remains active under `01a0942e-4f5c-75a0-b46b-795bb3b7dec7`; its
setup and lifecycle are recorded in [`session-restart-20260912.md`](session-restart-20260912.md).
The multiscale visual acceptance continuation is archived with immutable
receipts while its parent track remains active for the remaining production and
proof packets. Client queue identifiers are lifecycle aliases, not task or
commit identities.
