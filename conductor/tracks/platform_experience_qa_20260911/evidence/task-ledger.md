...
observed_at: 2026-09-12T04:40:59Z
---
...
now bound to immutable evidence and archived custody. The root browser receipt
is recorded at `e5eaab6` and reconciled into integration `9284d527`; keep the
platform QA task active for the remaining populated-data, mobile, agent-parity
and broader track gates. Superseded identities remain dated evidence and are not
relabeled as the final candidate.
