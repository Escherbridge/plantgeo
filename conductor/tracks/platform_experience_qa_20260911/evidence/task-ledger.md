...
mobile, agent-parity and broader track gates. The reader / gapless acceptance
and environmental retirement / offline export continuation tasks remain active;
the conformity continuation is archived with its immutable receipt while the
parent track remains active for the remaining proof packets.
