...
| Herbaria admission gate | `client-new-thread:5798d8ec-db17-4f5e-a5ad-5f4b402042c6` — PlantGeo Herbaria admission gate | Worktree setup pending | Dated source-governance receipt under `pnw_herbaria_source_admission_20260911/evidence/`; no commit yet | Active setup. Read-only WTU/UBC rights, coordinate-withholding, release identity and quarantine audit; no archive/specimen/media acquisition or data-plane access. |
| Botanical profile source contract | `client-new-thread:f7fc17f4-d86a-4ca5-b2f0-294f5052e400` — PlantGeo botanical profile source contract | Worktree setup pending | Dated immutable-lookup contract receipt under `botanical_species_profile_lookup_20260911/evidence/`; no commit yet | Active setup. Read-only taxonomy/growth/water-oil-fuel/agricultural source and provenance audit; no DB, pgt, Railway, ingestion or runtime change. |
| Forecast contract freeze | `client-new-thread:6f70e73b-4eae-44e1-8b52-ef99fbcb5c2f` — PlantGeo forecast contract freeze | Worktree setup pending | Dated forecast contract receipt under the weather forecast tracks; no commit yet | Active setup. Documentation-only model-run/valid-time, field/vector, selected-location and acceptance contract; no implementation or data operation. |
| PostgreSQL shrink proof audit | `client-new-thread:38b706ea-0752-41a7-810c-758aeb812265` — PlantGeo PostgreSQL shrink proof audit | Worktree setup pending | Dated remaining-proof receipt under `postgres_shrink_ingest_repoint_20260825/evidence/`; no commit yet | Active setup. Read-only package/removal and ownership reconciliation; historical bridge/drain plan is explicitly not restarted. |
| Service-backed QA gate matrix | `client-new-thread:dd4c97cc-6217-4f47-a687-da30ace6b8e0` — PlantGeo service-backed QA gate matrix | Worktree setup pending | Dated acceptance matrix under `platform_experience_qa_20260911/evidence/`; no commit yet | Active setup. Read-only populated-data, mobile/touch, reader, visual, role/accessibility and agent/MCP gate inventory; shared ledger and runtime files excluded. |
...
Five further lane-aware, read-only sessions were dispatched for the next
active-track gates: Herbaria admission
(`client-new-thread:5798d8ec-db17-4f5e-a5ad-5f4b402042c6`), botanical profile
source contract (`client-new-thread:f7fc17f4-d86a-4ca5-b2f0-294f5052e400`),
forecast contract freeze
(`client-new-thread:6f70e73b-4eae-44e1-8b52-ef99fbcb5c2f`), PostgreSQL shrink
proof (`client-new-thread:38b706ea-0752-41a7-810c-758aeb812265`) and the
service-backed QA gate matrix
(`client-new-thread:dd4c97cc-6217-4f47-a687-da30ace6b8e0`). Their worktree
setup is asynchronous; each is bounded to its own dated evidence file and may
not touch writers, databases, Railway, object storage, schedulers, APIs, UI
runtime files or deployment. Replace each client alias with its materialized
task ID and commit/tree before integration, independent review and archival.
