...
status: deployed_bounded_smoke_verified_full_qa_open
---
...
Generated receipt SHA-256: `4229c16dcd0ac081abe50f26b367e3a6997708f73916401df8f67b7670e4cf77` (1,019 bytes). The retained recovery summary at `.omc/research/runbook-20260914/release/receipt-recovery/attempt-c9af52e8459a40908d56a27d9c84af0a/result-summary.json` has SHA-256 `dab62c8d1986e99a34f6ced9699fa403ac64be2fb58442788802b986545205db`. Its source export, executed harness, complete JUnit, skip ledger and actual writer/verifier outputs remain locally retained. The following section records the corrective deployment after this receipt was committed.

## Corrective deployment and final confirmation

The exact generated receipt was independently approved, copied unchanged, and accepted by the existing verifier against the host tree. Commit `d167e7f0231804827422f0788f3b0604393a8ba8` then pushed successfully. It changes only the receipt and three Conductor documents; application source remains identical to the first checkpoint. The original failed builds above remain evidence of the missed receipt requirement.

All four deployments of the corrective commit succeeded, as retained in `.omc/research/runbook-20260914/release/corrective-deployments-success.json`:

| Service | Deployment | SUCCESS timestamp (UTC) |
| --- | --- | --- |
| Frontend | `a595f651-3482-4df2-ad61-4ef07933c19a` | 2026-09-15T00:40:07.019Z |
| Data API | `690c027b-4daa-4c97-8def-bfd9fa645ee2` | 2026-09-15T00:36:20.689Z |
| Job executor | `62fdcac0-e9eb-4fb4-add6-24beb459b96b` | 2026-09-15T00:36:01.050Z |
| Martin | `6a935172-4cbb-4d01-988d-ee81c04d16b5` | 2026-09-15T00:35:24.872Z |

The new frontend build again passed all 193 files / 2,542 tests, production compilation and readiness. Both Python image builds accepted the fresh 885-input receipt. After all services reported SUCCESS on this revision, the unchanged reviewed live smoke ran again: `attempt-20260915-0040`, **4/4 passed in 38.041 seconds**, no retries, skips or flaky results. Its report SHA-256 is `abe2584fbbef94373a5122dc9a4d72de8766dd43a0c5f33bce454ab29f4171a1` and metadata pins the corrective commit; actual deployment evidence supplies that external revision binding.

Acceptance remains limited to the four automated control/data/entry cases. Independent review of the prior settled captures accepted the now-visible proposal map/controls on both viewports but did not accept weather overlay visibility. D260915-29's feed disclosure correction and D260915-30's weather-rendering investigation remain open. The final confirmation does not promote whole QA cases, model behavior, authenticated contributions, source admission or scheduled advances. Post-deployment evidence is updated locally and queued for the next reviewed incremental checkpoint.
