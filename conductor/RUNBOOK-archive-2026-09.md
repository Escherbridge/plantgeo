...
# PlantGeo runbook archive: September 1–9, 2026

Archived during the September 11 session cleanup. The original runbook body below
is preserved verbatim from its title onward, including later corrections and
contradictory handoffs. Its former branch/head, LIVE labels, process IDs, service
counts and pending actions describe those dated sessions, not present state.
Use the [current runbook](RUNBOOK.md), [work registry](tracks.md) and linked
receipts before continuing an operation. This archive grants no new authorization.

The opening September 4 summary was superseded inside this same document by the
September 7 availability flip and September 9 database rebuild. September 10
source repairs and temperature publication, and September 11 MTBS rollout, are
indexed in the current runbook and their owning tracks. Do not replay archived
mutation commands as a continuation plan.

Older numbered references such as §0.23, §0.24 and §0.41 belong to the
[August archive](RUNBOOK-archive-2026-08.md). Relative links within the retained
September body keep their original conductor-directory base.

Preservation hashes (UTF-8, original working-copy line endings):

- Original entire `RUNBOOK.md`: `6769e637e0dc1fc09292d76a6f90676d3f07f66e4a0609d48ddbf99ad548c501`.
- Retained body from its original title through EOF: `19e9a68ed0e39d6e0aedaa275ae3cd3fe36e74ffb3cb441e2f774ff5114929af`.
