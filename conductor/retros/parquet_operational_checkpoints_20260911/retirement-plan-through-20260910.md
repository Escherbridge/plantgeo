...
status: historical
source: conductor/tracks/environmental_postgres_retirement_20260904/plan.md
archived_on: 2026-09-11
source_sha256: 910efcd6901e0fe7fb0c361c96df57b00c19dad625c1b42a56739f2c0fc67901
---

# Archived retirement plan through September 10

The original plan body follows, including its old frontmatter; its relative
evidence links are rebased to the source track. Its unchecked tasks and command
examples are historical instructions.
Use the [current plan](../../tracks/environmental_postgres_retirement_20260904/plan.md)
for execution. Original `evidence/` references resolve under that track directory.
...
September 10 preparation checkpoint: [signal/sensor candidates and soil reader validation](../../tracks/environmental_postgres_retirement_20260904/evidence/repair-preparation-20260910.md).
This records bounded preparation, not completed publication or closure of the active repair work.

The [current MTBS capture and four-resolution preparation](../../tracks/environmental_postgres_retirement_20260904/evidence/mtbs-current-capture-20260910.md)
passed independent source and geometry verification. Publication and pre-2018 recovery remain pending.

The [saved static-soil evidence and proposed bucket admission](../../tracks/environmental_postgres_retirement_20260904/evidence/soil-static-admission-preparation-20260910.md)
