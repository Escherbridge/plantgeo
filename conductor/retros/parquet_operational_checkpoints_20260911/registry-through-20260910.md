...
source_sha256: 2e60b6ad2dc6562427550bbadc37db2cd8e0339fa7e5f82df7c82bf2f4c8c8c3
---

# Registry before the September 11 reconciliation

This preserves the prior registry body, including its complete historical index
and August 22 pivot audit. Relative links are rebased to the original `conductor/`
directory; conclusions and statuses retain their recorded dates. It is not an
execution registry. Use the [current registry](../../tracks.md).
...
Registry archival audit updated 2026-09-10. The earlier implementation checkpoint
was waves 1–3 through `12fa189`; this documentation update makes no new release claim.

Completed historical cutover slices are indexed in the
[cutover retrospective](../../retros/parquet_cutover_completed_slices_20260910/README.md).
Their parent tracks remain open for the named production and retirement gates.
...
| [postgres_shrink_ingest_repoint_20260825](../../tracks/postgres_shrink_ingest_repoint_20260825/) | active | feature | Shared `parquet_ops/` and the CLI split/rename are integrated. Forward writer, repair and executor work is delegated to `gapless_parquet_publication_20260901`; P5/P6 retirement is superseded by `environmental_postgres_retirement_20260904`. Retain this track's remaining work and historical bridge evidence; do not restart the old shared drain. |
| [environmental_postgres_retirement_20260904](../../tracks/environmental_postgres_retirement_20260904/) | active | infrastructure | **Current environmental retirement authority.** Owns the expanded feed/social-only PostgreSQL target, remaining environmental reader cutovers, backfill parity and per-relation retirement packets. Signal/sensor repairs, remaining gaps and acceptance evidence stay open. Each relation requires its own complete proof; successful temperature publication does not complete this track or authorize other drops. |
...
The [completed cutover slices archive](../../retros/parquet_cutover_completed_slices_20260910/README.md)
retains proven historical deliverables without closing their unfinished parent tracks.

| Track | Status | Type | Summary |
|-------|--------|------|---------|
| [parquet_cutover_completed_slices_20260910](../../retros/parquet_cutover_completed_slices_20260910/) | historical | retrospective | Completed pivot d0/d1/d3/d5 and existing design/lattice archives; original evidence retained, parent tracks remain open. |
