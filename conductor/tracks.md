...
| [PNW land reference plane](tracks/pnw_land_context_reference_plane_20260911/plan.md) | in_progress | BLM ingestion and crop estimates delivered under the September 20 authorization; unresolved parcel/utility/state sources continue in the PNW remaining land sources track. |
| [PNW land contact experience](tracks/pnw_land_contact_experience_20260911/plan.md) | in_progress | BLM office geography and documented inquiry records are published; broader verified contact routes remain in the PNW remaining land sources track. |
