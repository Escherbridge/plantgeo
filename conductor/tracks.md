...
| [pnw_herbaria_source_admission_20260911](tracks/pnw_herbaria_source_admission_20260911/plan.md) | planned | Admit or refuse named PNW Herbaria collection releases through collection-level rights, DwCA/EML schema, native-identity stability, bounded-processing and withdrawal evidence. Start with a WTU/UBC data-only pilot; acquire no images. |
