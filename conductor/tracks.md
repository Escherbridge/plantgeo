...
| Track | State | Outstanding work |
| --- | --- | --- |
| [PNW land data delivery](tracks/pnw_land_data_delivery_20260920/plan.md) | in_progress | PR #10 merged after corrective review and quality gates; deployment in progress. Deployed-code health, live API/browser acceptance, lane activation and first successful scheduled turns remain separate gates. |
| [PNW BLM sources](tracks/pnw_blm_sources_20260920/plan.md) | in_progress | PR #10 merged; deployment in progress. Initial boundaries, office jurisdictions and unverified inquiry records published; deployed readback, refresh/reconcile/backfill activation and successful turns remain. |
| [PNW crop-cover estimates](tracks/pnw_crop_cover_20260920/plan.md) | in_progress | PR #10 merged; deployment in progress. USDA CDL 2022–2025 editions published; all four editions verified through live API/browser, maintenance activation and a successful turn remain. |
...
| [PNW land reference plane](tracks/pnw_land_context_reference_plane_20260911/plan.md) | in_progress | PR #10 merged after review and quality gates; deployment in progress. Deployment acceptance and parcel/utility/state source admissions remain open in their delivery/deferred tracks. |
| [PNW land contact experience](tracks/pnw_land_contact_experience_20260911/plan.md) | in_progress | PR #10 merged; deployment in progress. BLM office geography and unverified inquiry records published; live product/accessibility/agent acceptance and broader verified routes remain open. |
