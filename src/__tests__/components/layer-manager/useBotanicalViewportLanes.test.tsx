 ...
 * returns (`src/hooks/useViewportProxiedLayers.ts:174-236`). Both are handed back deliberately:
 ...
 * (`src/hooks/useViewportProxiedLayers.ts:174-203`), which no consumer re-derives; the
